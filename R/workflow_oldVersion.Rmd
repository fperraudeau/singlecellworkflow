...
FP: this is the old version of the workflow, please use file workflow/workflow.Rmd that I created from package BiocWorkflowTools. Directory workflow in now all compatible with the bioc workflow format and we can directly convert the Rmd file to a tex file that can then be exported to overleaf for direct submission to F1000Research.
...
knitr::include_graphics('../workflow/workflow.png')
```
