...
K = 3, 4, 5 get same results, all good.
...
The input of slingshot is the MDS of W used for clusterExperiment where the number of dimensions is k where k in (3, 4, 5) here.
