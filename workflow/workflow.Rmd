...
# plotFeatureBoxplot(dataObj, whichCluster="primary", feature="Reg3g",ylab = "Reg3g normalized Expression values", cex.axis = .8, cex.lab = .8)
...
```{r}
pseudoCe <- dataObj[,!primaryClusterNamed(dataObj) %in% c("-1", "c1")]
