...
EP: If use SingleCellFilter (or davide adds to singleCellExperiment) could do this in 1 line.

EP: Why do we create 'core' rather than just replace 'dataObj'.   
FP: I agree, I think that it is unnecessary. I changed 'core' to dataObj.
...
plotDimReduce(dataObj,whichCluster="primary",reduceMethod="zinbwave50",pch=20,
...
EP: not sure why needed 'c4' object. This is new function. Tell me if you run into problems. 
