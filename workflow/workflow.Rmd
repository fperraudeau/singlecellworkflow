...
plotFeatureBoxplot(dataObj, whichCluster="primary", feature="Reg3g")
```
...
EP: Since changed NormalizedValues to the main assay, this cleans up the code above and below.
...
plotHeatmap(pseudoCe[,!is.na(t)], clusterSamplesData = "orderSamplesValue", breaks = .99)
```
