...
```{r pcanorm, fig.cap="ZINB-WaVE: PCA of normalized expression measures, where each point represents a cell. Cells are color-coded by batch (left panel) and by original published clustering (right panel).", fig.height=2.5}
pca <- prcomp(t(norm))
par(mfrow = c(1,2))
...
DR: do we actually need the PCA plots? The whole point of zinbwave is dimensionality reduction, I think it's very confusing to do PCA here, even before showing the results of zinbwave...
