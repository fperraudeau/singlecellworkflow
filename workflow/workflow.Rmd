...
Using the Bioconductor R package `scone`, we remove low-quality cells that did not pass our quality control filter, that is ... See Figure \@ref(fig:scone). Davide, would you like to describe your choices for scone here?
...
Finally, to speed up the computations, we retain only the 1,000 most variable genes. We recommend, however, not to be so stringent in an actual data analysis.
