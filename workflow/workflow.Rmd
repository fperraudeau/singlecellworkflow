...
if(packageVersion("clusterExperiment")<"1.3.1.9004") stop("must have current develop version to avoid bugs")
...
if(!file.exists("../data/GSE95601_oeHBCdiff_Cufflinks_eSet.Rda")) {
  ...
  R.utils::gunzip("../data/GSE95601_oeHBCdiff_Cufflinks_eSet.Rda.gz")
}
