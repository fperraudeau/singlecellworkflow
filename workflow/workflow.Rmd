...
[FP: add an additional comment to justify that we keep only 1000 most variable genes. We can say that it is enough to recover the signal from [@Fletcher2017]. ]
