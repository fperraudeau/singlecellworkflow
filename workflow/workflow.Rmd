...
EP: Why do we create 'core' rather than just replace 'dataObj'. I agree, I think that it is unnecessary. I changed 'core' to dataObj.
...
```{r addW}
reducedDim(dataObj,"zinbwave50")<-W
```
