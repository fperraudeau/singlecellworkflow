...
- try running workflow with more genes (DR if time),
- colors and labels in plotBarplot to compare original and our clustering (EP, DR),
- check removal cluster c4 (all)
