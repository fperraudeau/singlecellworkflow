...
More formally, we are interested in testing for variable expression over pseudotime. A general additive model (GAM) is a flexible, nonlinear way to model the relationship between a gene's normalized expression measures and pseudotime. We implemented this model for each gene and show the top 100 genes by p-value in the heatmap below.
