...
Before fitting the simultaneous principal curves, we check the structure of the lineages by plotting the MST on the clusters. This shows that our implementation has recovered the lineages found in the published work (Figure \@ref(fig:tree)). The `slingshot` package also includes methods for 3-dimensional visualizations similar to \@ref(fig:stemcelldiff), using the `plot3d` function from the package `rgl`.
...
pairs(lineages, type='curves', col = pal[primaryClusterNamed(ceObj)])
pairs(lineages, type='lineages', col = pal[primaryClusterNamed(ceObj)], show.constraints = TRUE)
