...
Note that in the following, we assume that the user has access to a data folder located at `../data`. Users with a different directory stracture may need to change the `data_dir` variable below to reproduce the workflow.
